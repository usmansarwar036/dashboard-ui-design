...
export default function HomePage() {
            ...
            case "passengers":
                return (
                    <div>
                        ...
                        <div className="max-h-screen space-y-4 p-4 dark:text-white">
    ...
    return (
        <div className="mx-auto max-w-sm space-y-6 rounded-xl bg-white p-4 shadow-xl">
            {/* Header */}
            ...
            {step && (
                <div className="fixed inset-0 z-50 !m-0 flex items-end justify-center bg-black/40 sm:items-center">
                    <div className="dark:bg-dark/[0.03] max-h-[80vh] w-full max-w-md rounded-2xl bg-white dark:border dark:border-gray-800">
                        {renderModal()}
                    </div>
                </div>
            )}
...
const FormField = ({ label, value, icon }) => (
    <div className="dark:bg-dark/[0.03] flex items-center justify-between rounded-lg border p-3 dark:border-gray-800 dark:text-white">
        <div>
