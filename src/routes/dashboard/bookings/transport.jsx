                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4 backdrop-blur">
                    <div className="max-h-[95%] w-full max-w-md overflow-auto rounded-2xl bg-white shadow-xl dark:bg-white/[0.03] dark:text-white">
                        ...
                        <div className="space-y-6 px-4 py-4 text-sm">
                            {/* Price */}
                            <div>
                                <label className="mb-1 block text-sm font-bold text-gray-700 dark:text-white">Price Range</label>
                            ...
                            {/* Seat Capacity */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Seats Capacity</label>
                            ...
                            {/* Providers */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Rental Providers</label>
                            ...
                            {/* Energy */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Energy Source</label>
                            ...
                            {/* Provider Policy */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Provider Policy</label>
                            ...
                            {/* Distance */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Distance</label>
                                <div className="flex flex-wrap gap-2">
                            ...
                            {/* Rating */}
                            <div>
                                <label className="block py-2 text-sm font-bold text-gray-700 dark:text-white">Rating</label>
                                <div className="flex flex-wrap gap-2">
                                    {ratingOptions.map((r) => (
                                        <button
                                            key={r}
